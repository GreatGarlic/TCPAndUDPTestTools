...
{
    public partial class UDP_IPv4_Client_Page : Form
    {
        public UDP_IPv4_Client_Page()
        {
            InitializeComponent();       
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    IPEndPoint ipeh_Local = new IPEndPoint(IPAddress.Any, Convert.ToInt32(comboBox1.Text));//Dns.GetHostByName(Dns.GetHostName()).AddressList[0]
